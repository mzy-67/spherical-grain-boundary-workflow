...
`outputs.xlsx` contains one worksheet (`Sheet1`) with a header row and 1,211 data rows. Each `id` is unique. Starting from 1,291 sampled candidates, Bayesian optimization succeeded for 1,230 and failed for 61; MSD calculations then succeeded for 1,211 and failed for 19. The workbook contains the 1,211 candidates that completed MSD analysis.
...
| `T_k_973.15` | Ionic conductivity at 973.15 K | S m⁻¹ |
| `T_k_1073.15` | Ionic conductivity at 1073.15 K | S m⁻¹ |
| `T_k_1173.15` | Ionic conductivity at 1173.15 K | S m⁻¹ |
| `T_k_1273.15` | Ionic conductivity at 1273.15 K | S m⁻¹ |
